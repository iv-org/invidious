...
LOCALES = {
  "العربية"    => load_locale("ar"),
  "Deutch"    => load_locale("de"),
  "ελληνικά"    => load_locale("el"),
  "English" => load_locale("en-US"),
  "Esperanto"    => load_locale("eo"),
  "Español"    => load_locale("es"),
  "Euskara"    => load_locale("eu"),
  "Français"    => load_locale("fr"),
  "Íslenska"    => load_locale("is"),
  "Italiano"    => load_locale("it"),
  "Norsk Bokmål" => load_locale("nb_NO"),
  "Nederlands"    => load_locale("nl"),
  "Język Polski"    => load_locale("pl"),
  "Pусский"    => load_locale("ru"),
  "Türkçe"    => load_locale("tr"),
  "Українська"    => load_locale("uk"),
  "汉语" => load_locale("zh-CN"),
  "漢語" => load_locale("zh-TW"),
}
