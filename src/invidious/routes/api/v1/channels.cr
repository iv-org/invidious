module Invidious::Routes::API::V1::Channels
  ...
  private macro get_channel
    begin
      ...
      return Errors.error_json(302, "Channel is unavailable", {"authorId" => ex.channel_id})
  ...
  def self.home(env)
    ...
    JSON.build do |json|
      ...
      json.object do
        ...
        json.field "description", Invidious::Helpers.html_to_content(channel.description_html)
        ...
        json.field "relatedChannels" do
          json.array do
            ...
            begin
              related_channels, _ = Invidious::Channels::About.fetch_related_channels(channel)
            rescue ex
  ...
  def self.playlists(env)
    ...
    items, next_continuation = Invidious::Channels::Playlists.fetch_channel_playlists(channel.ucid, channel.author, continuation, sort_by)
  ...
  def self.podcasts(env)
    ...
    items, next_continuation = Invidious::Channels::Playlists.fetch_channel_podcasts(channel.ucid, channel.author, continuation)
  ...
  def self.releases(env)
    ...
    items, next_continuation = Invidious::Channels::Playlists.fetch_channel_releases(channel.ucid, channel.author, continuation)
  ...
  def self.courses(env)
    ...
    items, next_continuation = Invidious::Channels::Playlists.fetch_channel_courses(channel.ucid, channel.author, continuation)
  ...
  def self.community(env)
    ...
    begin
      Invidious::Channels::Community.fetch_channel_community(ucid, continuation, locale, format, thin_mode)
    rescue ex
      return Errors.error_json(500, ex)
    end
  end
  ...
  def self.post(env)
    ...
    if ucid.nil?
      ...
      return Errors.error_json(400, "Invalid post ID") if response["error"]?
    ...
    begin
      Invidious::Channels::Community.fetch_channel_community_post(ucid, id, locale, format, thin_mode)
    rescue ex
      return Errors.error_json(500, ex)
    end
  end
