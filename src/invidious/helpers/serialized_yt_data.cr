    ...
    xml.element("entry") do
      ...
      xml.element("content", type: "xhtml") do
        xml.element("div", xmlns: "http://www.w3.org/1999/xhtml") do
          ...
          xml.element("p", style: "word-break:break-word;white-space:pre-wrap") { xml.text Invidious::Helpers.html_to_content(self.description_html) }
        end
      end
      ...
      xml.element("media:group") do
        ...
        xml.element("media:description") { xml.text Invidious::Helpers.html_to_content(self.description_html) }
      end
    ...
    xml.element("entry") do
      ...
      xml.element("content", type: "xhtml") do
        xml.element("div", xmlns: "http://www.w3.org/1999/xhtml") do
          ...
          xml.element("pre") do
            Errors.get_issue_template(env, @parse_exception)
          end
        end
      end
    end
