...
def get_about_info(ucid, locale) : AboutChannel
  ...
  if tabs_json = initdata["contents"]["twoColumnBrowseResultsRenderer"]["tabs"]?
    ...
    if !channel_about_meta.nil?
      ...
      auto_generated = initdata.dig?("header", "c4TabbedHeaderRenderer", "headerLinks",
        "channelHeaderLinksViewModel", "firstLink", "content").try &.as_s == "support.google.com/youtube/answer/2579942"
    end
  end
